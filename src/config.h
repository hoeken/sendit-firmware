...
#define YB_FIRMWARE_VERSION "2.6.1"
  ...
  #define YB_PROJECT_URL "https://sendit.yarrboard.com"
#endif
  ...
  #define YB_OTA_MANIFEST_URL "https://firmware.sendit.yarrboard.com/releases/ota_manifest.json";
#endif
